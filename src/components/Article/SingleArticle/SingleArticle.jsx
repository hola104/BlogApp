...
function SingleArticle({ article }) {
  ...
  const cardStyle =
    location === "articles-list"
      ? styles.preview
      : classNames(styles.preview, styles.singleCard);
  ...
  const likeStyl = classNames(
    styles.blackLike,
    token && styles.activeLike,
    article.liked && styles.redLike
  );
  ...
  return (
    <div className={styles.cardWrapper}>
      ...
      {location === "article-page" && (
        // eslint-disable-next-line react/no-children-prop
        <ReactMarkdown children={article.text} className={styles.pageText} />
      )}
